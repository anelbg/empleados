		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"> Editar usuarios </h4>
			...
			<div class="content">
				...
				<div class="mb-3">
					...
					<span class="text-muted d-block">En esta área se pondran editar los campos de los departamentos</span>
				</div>
					...
					<div class="col-md-4">
			            ...
			            <div class="card">
							<div class="card-header header-elements-inline">
				                <h6 class="card-title">cambio de campos</h6>
			               ...
			               <! <div class="card-body">
			                	<form action="#">
									<div class="form-group">
										<label>Nombre:</label>
										<input type="text" class="form-control" placeholder="coloque su usuario">
									</div>

									<div class="form-group">
										<label>contraseña:</label>
										<input type="password" class="form-control" placeholder="ingresé su contraseña">
									</div>

									<div class="form-group">
										<label>contraseña renovada</label>
										<input type="password" class="form-control" placeholder="ingresé la contraseña que deseé cambiar">
									</div>

									<div class="d-flex justify-content-start align-items-center">
										<button type="submit" class="btn btn-light">Cancelar</button>
										<button type="submit" class="btn bg-blue ml-3">Listo <i class="icon-paperplane ml-2"></i></button>
									</div>
								</form>
							</div>
		                </div>
