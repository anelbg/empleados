			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Altas de departamentos</h5>
					...
					<div class="card-body">
						<p class="mb-4">En esta sección subimos nuevos departamentos</p>

						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Tabla</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-md-2">Correo</label>
									<div class="col-md-10">
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										...
										<span class="form-text text-muted">Ingrese un numero de teléfono</span>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Ingrese el ultimo nivel de estudios">
									</div>
								</div>
