				...
				<div class="card card-sidebar-mobile">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Main -->
							...
							<a href="widgets_stats.html" class="nav-link active">
								<i class="icon-home4"></i>
					...
					-->
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="table_basic.html" class="nav-link">Tabla de contenido</a></li>
								<li class="nav-item"><a href="form_inputs.html" class="nav-link">Altas de de departamentos</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu">
								...
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">Altas de usuario</a></li>
								<li class="nav-item"><a href="form_actions.html" class="nav-link">Editar usuario</a></li>
					...
					-->
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-file-spreadsheet"></i> <span>Pago</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								<li class="nav-item"><a href="handsontable_basic.html" class="nav-link">pago del transporte</a></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Pricipal</a>
						...
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="card bg-teal-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">Empresas</h3>
											<span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+60%</span>
					                	</div>
					                	
					                	<div>
											entrada
											<div class="font-size-sm opacity-75">por dias</div>
										</div>
									</div>
							...
							<div class="col-lg-4">
								...
								<div class="card bg-pink-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">Departamento</h3>
							...
							<div class="col-lg-4">
								...
								<div class="card bg-blue-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">Empleados</h3>
											<div class="list-icons ml-auto">
					                	...
					                	<div>
											Progreso
											<div class="font-size-sm opacity-75">80%</div>
										</div>
									</div>
						...
						<div class="card">
							...
							<div class="table-responsive">
								<table class="table text-nowrap">
									...
									<tbody>
										<tr class="table-active table-border-double">
											<td colspan="3">horas trabajadas del dia</td>
											<!--<td class="text-right">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Andrea Charles</a>
											...
											<td>
												<a href="#" class="text-default">
													...
													<span class="text-muted">sistemas</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold">Aldo Puga</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
											<td>
												<a href="#" class="text-default">
													<div class="font-weight-semibold">Departamento</div>
													<span class="text-muted">Llenado</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Daniela Huerta</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Jose Alcocer</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
