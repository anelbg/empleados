			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tabla de contenido de departamentos</h4>
			...
			<div class="content">
				...
				<div class="card">
								<div class="card-header bg-transparent header-elements-inline">
									<span class="card-title font-weight-semibold">Busca el contenido</span>
								...
								<div class="card-body">
									<form action="#">
										<div class="form-group-feedback form-group-feedback-right">
											<input type="search" class="form-control" placeholder="tabla de contenido">
				...
				<div class="card">
					...
					<div class="card-body">
						En esta sección se muestra el contenido del área de departamentos
					</div>
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td>1</td>
								<td>Andrea Guadalupe</td>
								<td>Báez Guerrero</td>
								<td>Colonia Ejercito</td>
								<td>andre.bg_@gmail.com</td>
								<td>27</td>
								<td>558 080 73 60</td>
								<td>Maestria</td>
								</tr>
								...
								<tr>
									<td>3</td>
								<td>Ilse Monzerrat</td>
								<td>Padilla Guerrero</td>
								<td>colonia popular</td>
								<td>ilsitap.27@gmail.com</td>
								<td>25</td>
								<td>899 255 68 96 </td>
								<td>Maestria</td>
								</tr>
								...
								<tr>
									<td>5</td>
								<td>Federico</td>
								<td>Vildozo Austin</td>
								<td>colonia espinoza</td>
								<td>vildoz099@gmail.com</td>
								<td>22</td>
								<td>9 264 405 92 09</td>
								<td>Licenciatura</td>
								</tr>
								<tr>
									<td>6</td>
								<td>Cielo</td>
								<td>Pulido Perez</td>
								<td>calle transito</td>
								<td>sky01_pp@gmail.com</td>
								<td>24</td>
								<td>834 109 95 62 </td>
								<td>Licenciatura</td>
								</tr>
								<tr>
									<td>7</td>
								<td>Ariana Guadalupe</td>
								<td>mata Villanueva</td>
								<td>colonia Viento Huasteco</td>
								<td>arianaGmv@gmail.com</td>
								<td>34</td>
								<td>834 201 64 32</td>
								<td>Doctorado</td>
								</tr>
								<tr>
									<td>8</td>
								<td>Jessany Yamileth</td>
								<td>Garza Soto</td>
								<td>Colonia Moderna</td>
								<td>Jessany_Gs.01@gmail.com</td>
								<td>22</td>
								<td>834 109 82 92 </td>
								<td>Maestria</td>
								</tr>
								<tr>
									<td>9</td>
								<td>Christian</td>
								<td>Gutierrez Manzano</td>
								<td>26boulevard</td>
								<td>manzanoCH_@gmail.com</td>
								<td>22</td>
								<td>834 198 65 25 </td>
								<td>Licenciatura</td>
								</tr>
								<tr>
									<td>10</td>
								<td>Eduardo</td>
								<td>Avalos Villanueva</td>
								<td>colonia Santa Catarina</td>
								<td>Babo_cs.eav@gmail.com</td>
								<td>42</td>
								<td>834 107 85 22</td>
								<td>Doctorado</td>
								</tr>
